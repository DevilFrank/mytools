import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { v as closePrerenderer, x as localFetch } from './chunks/nitro/nitro.mjs';
