...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderList } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { t } = useI18n();
    const sectionKeys = [
      "pages.contact.sections[0]",
      "pages.contact.sections[1]",
      "pages.contact.sections[2]"
    ];
    useSeo({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))}><div class="content-shell"><h1 class="text-4xl font-bold tracking-normal text-slate-950">${ssrInterpolate(_ctx.$t("pages.contact.h1"))}</h1><div class="prose-section"><p>${ssrInterpolate(_ctx.$t("pages.contact.intro"))}</p><p>${ssrInterpolate(_ctx.$t("pages.contact.emailLabel"))}: <a${ssrRenderAttr("href", `mailto:${unref(config).public.contactEmail}`)}>${ssrInterpolate(unref(config).public.contactEmail)}</a></p><!--[-->`);
...
//# sourceMappingURL=contact-BormrD01.mjs.map
