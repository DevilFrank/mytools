import { defineComponent, mergeProps, useSSRContext } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { t } = useI18n();
    const sectionKeys = [
      "pages.terms.sections[0]",
      "pages.terms.sections[1]",
      "pages.terms.sections[2]",
      "pages.terms.sections[3]"
    ];
    useSeo({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))}><div class="content-shell"><h1 class="text-4xl font-bold tracking-normal text-slate-950">${ssrInterpolate(_ctx.$t("pages.terms.h1"))}</h1><div class="prose-section"><p>${ssrInterpolate(_ctx.$t("pages.terms.intro"))}</p><!--[-->`);
...
//# sourceMappingURL=terms-BzW11Iac.mjs.map
