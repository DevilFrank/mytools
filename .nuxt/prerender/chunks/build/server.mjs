import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, computed, shallowRef, toRef, isRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/devilfrank/project/mytools/node_modules/ofetch/dist/node.mjs';
import { t as baseURL } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///Users/devilfrank/project/mytools/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/devilfrank/project/mytools/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, getRequestProtocol, getRequestHeaders, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file:///Users/devilfrank/project/mytools/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, isNavigationFailure, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/devilfrank/project/mytools/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/devilfrank/project/mytools/node_modules/defu/dist/defu.mjs';
import { klona } from 'file:///Users/devilfrank/project/mytools/node_modules/klona/dist/index.mjs';
import { parse as parse$1 } from 'file:///Users/devilfrank/project/mytools/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///Users/devilfrank/project/mytools/node_modules/destr/dist/index.mjs';
import { isEqual as isEqual$1 } from 'file:///Users/devilfrank/project/mytools/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///Users/devilfrank/project/mytools/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/server-renderer/index.mjs';
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = {}, $1 = { redirect: "/sitemap_index.xml" }, $2 = { redirect: "/__sitemap__/index.xml" }, $3 = { redirect: "/__sitemap__/en.xml" }, $4 = { redirect: "/__sitemap__/zh-CN.xml" };
  return (m, p) => {
    let r = [];
    ...
    if (p === "/sitemap.xsl") {
      ...
      r.unshift({ data: $3 });
    } else if (p === "/__sitemap__/zh-CN.xml") {
      r.unshift({ data: $0 });
    } else if (p === "/zh-CN-sitemap.xml") {
      r.unshift({ data: $4 });
    }
    return r;
  };
...
const component_45stubGUglMYIfXLA_45o7aZ6pJF13bHb7L0_OtbabXX8v82chY = {};
const _routes = [
  {
    name: "about___en",
    path: "/about",
    component: () => import('./about-BJqD1nAt.mjs')
  },
  {
    name: "about___zh-CN",
    path: "/zh-CN/about",
  ...
  },
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-CSFUMqDX.mjs')
  },
  {
    name: "index___zh-CN",
    path: "/zh-CN",
  ...
  },
  {
    name: "terms___en",
    path: "/terms",
    component: () => import('./terms-BzW11Iac.mjs')
  },
  {
    name: "terms___zh-CN",
    path: "/zh-CN/terms",
  ...
  },
  {
    name: "contact___en",
    path: "/contact",
    component: () => import('./contact-BormrD01.mjs')
  },
  {
    name: "contact___zh-CN",
    path: "/zh-CN/contact",
    component: () => import('./contact-BormrD01.mjs')
  },
  {
    name: "tools___en",
    path: "/tools",
    component: () => import('./index-D0l3Ewbv.mjs')
  },
  {
    name: "tools___zh-CN",
    path: "/zh-CN/tools",
  ...
  {
    name: "tools-base64___en",
    path: "/tools/base64",
    component: () => import('./base64-1ohpiPfe.mjs')
  },
  {
    name: "tools-base64___zh-CN",
    path: "/zh-CN/tools/base64",
    component: () => import('./base64-1ohpiPfe.mjs')
  },
  {
    name: "privacy-policy___en",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-CxiyuI6H.mjs')
  },
  {
  ...
  {
    name: "tools-url-encoder___en",
    path: "/tools/url-encoder",
    component: () => import('./url-encoder-eM7DfMiY.mjs')
  },
  {
    name: "tools-url-encoder___zh-CN",
    path: "/zh-CN/tools/url-encoder",
    component: () => import('./url-encoder-eM7DfMiY.mjs')
  },
  {
    name: "tools-json-formatter___en",
    path: "/tools/json-formatter",
    component: () => import('./json-formatter-DdnRyntu.mjs')
  },
  {
    name: "tools-json-formatter___zh-CN",
    path: "/zh-CN/tools/json-formatter",
    component: () => import('./json-formatter-DdnRyntu.mjs')
  },
  {
    name: "tools-sls-sql-generator___en",
    path: "/tools/sls-sql-generator",
    component: () => import('./sls-sql-generator-36qpe0VN.mjs')
  },
  {
    name: "tools-sls-sql-generator___zh-CN",
    path: "/zh-CN/tools/sls-sql-generator",
    component: () => import('./sls-sql-generator-36qpe0VN.mjs')
  },
  {
    name: "tools-user-agent-parser___en",
    path: "/tools/user-agent-parser",
    component: () => import('./user-agent-parser-DsFYWs-D.mjs')
  },
  {
    name: "tools-user-agent-parser___zh-CN",
    path: "/zh-CN/tools/user-agent-parser",
    component: () => import('./user-agent-parser-DsFYWs-D.mjs')
  },
  {
    name: "tools-timestamp-converter___en",
    path: "/tools/timestamp-converter",
    component: () => import('./timestamp-converter-C4R2tfBy.mjs')
  },
  {
    name: "tools-timestamp-converter___zh-CN",
    path: "/zh-CN/tools/timestamp-converter",
    component: () => import('./timestamp-converter-C4R2tfBy.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/sitemap.xml",
    component: component_45stubGUglMYIfXLA_45o7aZ6pJF13bHb7L0_OtbabXX8v82chY
  },
  {
    name: __nuxt_page_meta?.name,
  ...
  en: [
    {
      ...
      load: () => import(
        './en-BUwoDMpC.mjs'
        /* webpackChunkName: "locale_en_46json_45fd81b0" */
      ),
      cache: true
    }
  ],
  "zh-CN": [
    {
      ...
      load: () => import(
        './zh-CN-zzaAFkOq.mjs'
        /* webpackChunkName: "locale_zh_45CN_46json_1e4f8a83" */
      ),
      cache: true
    }
  ]
...
const ssg_detect_IpHCGcQQ_IR5Rl99qyukWoMA9fJGfuTYyoksTzy81cs = /* @__PURE__ */ defineNuxtPlugin({
  ...
  setup(_nuxt) {
    const nuxt = useNuxtApp(_nuxt._id);
    if (nuxt.$i18n.strategy !== "no_prefix" || !runtimeDetectBrowserLanguage()) return;
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C7XoTDMV.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CX_8Pjpb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-bQ1n45AA.mjs'));
...
export { _export_sfc as _, useRuntimeConfig as a, useLocalePath as b, useSwitchLocalePath as c, useRouter as d, entry_default as default, encodeRoutePath as e, useNuxtApp as f, withoutTrailingSlash as g, hasProtocol as h, isScriptProtocol as i, joinURL as j, nuxtLinkDefaults as k, navigateTo as n, parseQuery as p, resolveRouteObject$1 as r, tryUseNuxtApp as t, useI18n as u, withTrailingSlash as w };
