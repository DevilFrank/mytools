import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/devilfrank/project/mytools/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///Users/devilfrank/project/mytools/node_modules/h3/dist/index.mjs';
import { i as buildAssetsURL, p as publicAssetsURL, k as useRuntimeConfig, l as useStorage, m as encodePath, o as defineRenderHandler, q as getRouteRules, j as joinURL, c as useNitroApp } from '../nitro/nitro.mjs';
import { renderToString } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/devilfrank/project/mytools/node_modules/unhead/dist/server.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/devilfrank/project/mytools/node_modules/devalue/index.js';
import { FlatMetaPlugin, DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/devilfrank/project/mytools/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/devilfrank/project/mytools/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///Users/devilfrank/project/mytools/node_modules/vue/index.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Free browser-based tools for developers, data analysts, and website operators."}],"link":[],"style":[],"script":[{"async":true,"src":"https://www.googletagmanager.com/gtag/js?id=G-PZHTHBJXYN"},{"innerHTML":"\n            window.dataLayer = window.dataLayer || [];\n            function gtag(){dataLayer.push(arguments);}\n            gtag('js', new Date());\n            gtag('config', 'G-PZHTHBJXYN');\n          "},{"async":true,"src":"https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1090956656099890","crossorigin":"anonymous"}],"noscript":[],"htmlAttrs":{"lang":"en"}};
